    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                // shadow recieve 将 世界坐标 转到 灯光坐标（阴影坐标）
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                // shadow recieve 如果不需要用到 Light 结构的数据，可以直接使用该接口来获取
        ...
        Pass //有 ApplyShadowBias
        {
            ...
            // Shadows.hlsl 中的 ApplyShadowBias copy 过来
